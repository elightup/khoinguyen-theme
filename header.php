				...
				<div class="sidebar-top container">
					...
					<div class="header_bottom-cart">
						<?php if ( ! is_user_logged_in() ) : ?>
							...
							$user_name    = $user_name ? $user_name : $user_current->display_name;
							$wallet       = get_user_meta( $user_id, 'wallet', true ) ? get_user_meta( $user_id, 'wallet', true ) : 0;
							?>
							<span>Chào bạn, <?php echo esc_html( $user_name ); ?></span>
							<span class="tichdiem">Số dư:
							<?php
							echo number_format( $wallet, 0, ',', '.' ) . ' ₫';
							?>
					...
					<?php if ( is_user_logged_in() ) : ?>
						...
						<div id="popup-logout" class="popup-logout mfp-hide white-popup-block">
							...
							<a class="btn-primary wp-block-button__link" href="<?= esc_url( wp_logout_url( home_url() ) ); ?>">Có</a>
						</div>
					<?php endif ?>
				</div>
			</div>
				...
				<div class="container row">
					...
					<div class="header_top-contact">
						<p class="contact">
							...
							<strong>
								<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/phone.png" alt="">&nbsp;
								<span class="phone">
					...
					<div class="header_top-search">
						<form action="<?php echo esc_url( home_url() ); ?>/" method="get" class="header-search">
							...
							<div class="btn-search">
								<span><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/search.png" alt=""></span>
							</div>
						</form>
					</div>

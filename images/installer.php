...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210407_giathuoctot_6af06129085dee1e2647_20210824032142_archive.zip';
	const ARCHIVE_SIZE		 = '45963479';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '6af0612-24032142';
    const SECONDARY_PACKAGE_HASH = 'e73399b-24032142';
	const VERSION			 = '1.4.2';
